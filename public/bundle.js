...
var StateFullComponent = function (_Component) {
	...
	function StateFullComponent() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = StateFullComponent.__proto__ || Object.getPrototypeOf(StateFullComponent)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
	...
	_createClass(StateFullComponent, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(StateLessComponent, { text: this.state.text });
		}
	}]);
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(StateFullComponent, null), document.getElementById('root'));
